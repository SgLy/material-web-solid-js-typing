...
declare module 'solid-js' {
  namespace JSX {
    interface IntrinsicElements {
      'md-elevated-button': MaterialWeb.MdElevatedButton<HTMLDivElement>;
      'md-filled-button': MaterialWeb.MdFilledButton<HTMLDivElement>;
      'md-filled-tonal-button': MaterialWeb.MdFilledTonalButton<HTMLDivElement>;
      'md-outlined-button': MaterialWeb.MdOutlinedButton<HTMLDivElement>;
      'md-text-button': MaterialWeb.MdTextButton<HTMLDivElement>;
      'md-checkbox': MaterialWeb.MdCheckbox<HTMLDivElement>;
      'md-chip-set': MaterialWeb.MdChipSet<HTMLDivElement>;
      'md-assist-chip': MaterialWeb.MdAssistChip<HTMLDivElement>;
      'md-filter-chip': MaterialWeb.MdFilterChip<HTMLDivElement>;
      'md-input-chip': MaterialWeb.MdInputChip<HTMLDivElement>;
      'md-suggestion-chip': MaterialWeb.MdSuggestionChip<HTMLDivElement>;
      'md-dialog': MaterialWeb.MdDialog<HTMLDivElement>;
      'md-divider': MaterialWeb.MdDivider<HTMLDivElement>;
      'md-fab': MaterialWeb.MdFab<HTMLDivElement>;
      'md-branded-fab': MaterialWeb.MdBrandedFab<HTMLDivElement>;
      'md-focus-ring': MaterialWeb.MdFocusRing<HTMLDivElement>;
      'md-icon-button': MaterialWeb.MdIconButton<HTMLDivElement>;
      'md-filled-icon-button': MaterialWeb.MdFilledIconButton<HTMLDivElement>;
      'md-filled-tonal-icon-button': MaterialWeb.MdFilledTonalIconButton<HTMLDivElement>;
      'md-outlined-icon-button': MaterialWeb.MdOutlinedIconButton<HTMLDivElement>;
      'md-list': MaterialWeb.MdList<HTMLDivElement>;
      'md-list-item': MaterialWeb.MdListItem<HTMLDivElement>;
      'md-menu': MaterialWeb.MdMenu<HTMLDivElement>;
      'md-menu-item': MaterialWeb.MdMenuItem<HTMLDivElement>;
      'md-sub-menu': MaterialWeb.MdSubMenu<HTMLDivElement>;
      'md-linear-progress': MaterialWeb.MdLinearProgress<HTMLDivElement>;
      'md-circular-progress': MaterialWeb.MdCircularProgress<HTMLDivElement>;
      'md-radio': MaterialWeb.MdRadio<HTMLDivElement>;
      'md-ripple': MaterialWeb.MdRipple<HTMLDivElement>;
      'md-filled-select': MaterialWeb.MdFilledSelect<HTMLDivElement>;
      'md-outlined-select': MaterialWeb.MdOutlinedSelect<HTMLDivElement>;
      'md-select-option': MaterialWeb.MdSelectOption<HTMLDivElement>;
      'md-slider': MaterialWeb.MdSlider<HTMLDivElement>;
      'md-switch': MaterialWeb.MdSwitch<HTMLDivElement>;
      'md-tabs': MaterialWeb.MdTabs<HTMLDivElement>;
      'md-primary-tab': MaterialWeb.MdPrimaryTab<HTMLDivElement>;
